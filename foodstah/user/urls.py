...
from user.forms import MyAuthenticationForm
...
urlpatterns = [
    ...
    path(
        "login/",
        auth_view.LoginView.as_view(form_class=MyAuthenticationForm,template_name="user/login.html"),
        name="login",
    ),
    path(
        "logout/",
    ...
    path(
        "password-reset/done/",
        auth_view.PasswordResetDoneView.as_view(template_name="user/password_reset_done.html"),
